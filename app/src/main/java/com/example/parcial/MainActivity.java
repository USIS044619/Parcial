...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabHost tbhConversor = (TabHost) findViewById(R.id.tbhParcial);
        tbhConversor.setup();
        String str = "Universal";
        tbhConversor.addTab(tbhConversor.newTabSpec(str).setIndicator(str, null).setContent(R.id.tabUniversal));
        String str2 = "Area";
    ...
    public void procesar(View v) {
        try {
            ...
            TextView temp2 = (TextView) findViewById(R.id.txtcantidades);
            TextView valor = (TextView) findViewById(R.id.txtvalores);
            String str2 = "/";
            if (!temp2.getText().toString().equals(str)) {
                int cantidades = Integer.parseInt(temp2.getText().toString());
                int cajas = cantidades / unidades;
                StringBuilder sb = new StringBuilder();
                sb.append(cajas);
                sb.append(str2);
                sb.append(cantidades % unidades);
